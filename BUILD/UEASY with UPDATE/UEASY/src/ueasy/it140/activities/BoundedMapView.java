...
public class BoundedMapView extends MapView {
	...
	public BoundedMapView(Context context, ResourceProxy resourceProxy,
		...
		super(context, provider.getTileSource().getTileSizePixels(),
				resourceProxy, provider);

	}

	public BoundedMapView(final Context context, final AttributeSet attrs) {
		super(context, 256, new DefaultResourceProxyImpl(context), null, null,
				attrs);
	}

	public BoundedMapView(final Context context, final int tileSizePixels) {
