...
public class Campus extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (position == 0) {
			...
			Toast.makeText(
					this,
					"Sorry, only the Talamban Campus is available at this moment.",
	...
	public void checkUpdates() {
		...
		// Checks if new records are inserted in Remote MySQL DB to proceed with
		// Sync operation
		client.post("http://192.168.56.1/ueasy/databaseVersion.php", params,
