 ...
 * 
 */
public class CustomOverlayItem {
         ...
         * @param aGeoPoint
         */
        public CustomOverlayItem(final String aTitle, final String aDescription,
                        final GeoPoint aGeoPoint, final Drawable mMarker) {
                this(-1L, aTitle, aDescription, aGeoPoint);
                this.mMarker = mMarker;
        }

        public CustomOverlayItem(final long aKey, final String aTitle,
