...
public class BuildingCategory extends ListActivity implements Parcelable {
	  List<String> values;
...
//		   public static final Parcelable.Creator<BuildingCategory> CREATOR = new Parcelable.Creator<Student>() {
//			   
//		        @Override
//		        public BuildingCategory createFromParcel(Parcel source) {
//		            return new Student(source);
//		        }
//		 
//		        @Override
//		        public BuildingCategory[] newArray(int size) {
